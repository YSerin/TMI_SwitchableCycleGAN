...
def parse_arguments():
    ...
    parser.add_argument('--data_type', type=str, default='Head', help='Facial_bone or Head')
    parser.add_argument('--name', type=str, default='experiment_name', help='name of the experiment')
    parser.add_argument('--load_val_id', type=str, default='0', help='if specified, print more debugging information')
    parser.add_argument('--load_epoch_list', type=str, default='200,0,0,0,0', help='if specified, print more debugging information')
